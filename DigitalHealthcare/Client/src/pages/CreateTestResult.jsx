...
const CreateTestResult = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (normalizedType.length > MAX_TESTTYPE_LENGTH) {
      setMessage(`Test type must be at most ${MAX_TESTTYPE_LENGTH} characters.`);
      return;
    }

    if (normalizedResult.length > MAX_TESTRESULT_LENGTH) {
      setMessage(`Test result must be at most ${MAX_TESTRESULT_LENGTH} characters.`);
      return;
    }
