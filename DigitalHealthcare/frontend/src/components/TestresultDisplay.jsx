...
import { fetchTestresultsForUser } from '../services/databaseService'; 
...
export default function TestresultDisplay() {
    ...
    return (
        ...
        {entries.map(entry => (
            ...
            <p>{sanitizeUserInput(entry.test_type)}</p>
            <p>{sanitizeUserInput(entry.test_result)}</p>
